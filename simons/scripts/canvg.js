	...
	function build(opts) {
		...
		svg.Element.marker = function(node) {
			...
			this.render = function(ctx, point, angle) {
				...
				tempSvg.attributes['width'] = new svg.Property('width', this.attribute('512').value);
				tempSvg.attributes['height'] = new svg.Property('height', this.attribute('512').value);
				tempSvg.attributes['fill'] = new svg.Property('fill', 'white');
